...
@section('content')
<div class="mb-5 mt-5">
       <h1 class="text-3xl text-center font-bold text-gray-900 mb-10">Create Category</h1>
</div>
...
@endif
  <form action="{{ route('category.store') }} " method="post" enctype="multipart/form-data">
    ...
    <div class="form-group mb-6">
      <label for="name" class="text-slate-900 text-lg mb-3 font-bold">Category Name :</label>
    ...
    <button type="submit" class="
      ...
      transition
      duration-150
      ease-in-out">Create Category</button>
  </form>
