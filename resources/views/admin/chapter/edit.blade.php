...
@section('content')
<div class="mb-5 mt-5">
       <h1 class="text-3xl text-center font-bold text-gray-900 mb-10">edit chapter</h1>
</div>
...
@endif
  <form action="{{ route('chapter.update',$chapter->id) }} " method="post" enctype="multipart/form-data">
    ...
    <div class="form-group mb-6">
      ...
      <input name="name" type="text" value="{{ $chapter->name }}" class="form-control block
        w-full
        px-3
        py-1.5
        text-base
    ...
    <div class="form-group mb-6">
      ...
      <input name="title" type="text" value="{{ $chapter->title }}" class="form-control block
        w-full
        px-3
        py-1.5
        text-base
...
<input type="hidden" name="manga_id" value="{{ $manga->id }}">
    ...
    <button type="submit" class="
      ...
      transition
      duration-150
      ease-in-out">edit chapter</button>
  </form>
