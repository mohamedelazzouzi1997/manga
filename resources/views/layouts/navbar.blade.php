...
<div class="mx-auto relative ">
    <div class="bg-cover bg-center" style="background-image: url('{{ asset('images/cover.jpg') }}'); height:350px" class="w-full">
        <div class="bg-black absolute bottom-0 top-0 right-0 left-0 z-10 opacity-50">

        </div>
        <div class="flex justify-center items-center h-full px-5 md:px-40">
            <h1 class="text-center text-5xl font-extrabold text-white z-50 py-3 px-20 border-4 w-full">
               <a href="{{ url('/') }}" class="hover:underline uppercase">read manga {{ App\Models\Manga::first()->name; }}</a>
            </h1>
        </div>
    </div>
</div>
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 dark:bg-gray-900 shadow-xl mb-20">
  ...
  <div class="flex items-center md:order-2">
      <button id="theme-toggle" type="button" class="text-gray-500 flex border dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
          <span class="self-center dark:text-gray-200 text-slate-900 mr-3">MODE</span>
